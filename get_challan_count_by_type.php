...
<form action="get_challan_count_by_type.php" method="post">
    <label for="violation_type"><h3>Enter violation_type:</h3></label>
...
<div class="container">
   ...
   <?php
       ...
       $sql = "CALL get_challan_count_by_type('$violation_type')";

      $result = mysqli_query($con, $sql);
      $cp="NO Paid Challan Found";
      if (mysqli_num_rows($result) > 0)
        {
          $cc;
          while ($row = mysqli_fetch_assoc($result)) {
            $cc=$row['challan_count'];
